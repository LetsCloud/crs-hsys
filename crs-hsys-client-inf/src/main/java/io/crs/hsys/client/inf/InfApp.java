 ...
 * 
 */
package io.crs.hsys.client.inf;
 ...
 *
 */
public class InfApp extends AbstractAppBootstrapper {

	@Inject
	InfApp(PlaceManager placeManager, AppData appData, ResourceDelegate<GlobalConfigResource> globalConfigResource,
