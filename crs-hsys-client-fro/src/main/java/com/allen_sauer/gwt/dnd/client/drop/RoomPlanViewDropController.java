...
import io.crs.hsys.client.fro.roomplan.widget.BookingWidget;
 ...
 */
public class RoomPlanViewDropController extends AbsolutePositionDropController {
...
//	private static final String BACKGROUND = "backgroundColor";
	...
	public RoomPlanViewDropController(final AbsolutePanel dropTarget, final FlexTable monthGrid) {
...
//						DOM.setStyleAttribute(elem, BACKGROUND, "#FFFFFF");
			...
			Date startDate = ((BookingWidget) draggable.widget).getAppointment().getStart();
			Date endDate = ((BookingWidget) draggable.widget).getAppointment().getEnd();
