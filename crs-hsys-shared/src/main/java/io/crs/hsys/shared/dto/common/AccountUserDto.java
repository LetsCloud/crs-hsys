...
public class AccountUserDto extends BaseDto {
	...
	public AccountUserDto(String picture, Boolean enabled, String name, String emailAddress) {
		this();
	...
	public String toString() {
		String ret = "AccountUserDto:{name=" + name + ", username=" + username + ", password=" + password
